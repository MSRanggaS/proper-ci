      ...
      <section role="main" class="content-body">
        ...
        <section class="panel">
          <header class="panel-heading">
            ...
            <h2 class="panel-title">User Admin</h2>
          </header>
          <div class="panel-body">
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
              ...
              <tbody>
                ...
                <tr>
                  <td class="va-middle"><?= $d['name'] ?></td>
                  <td class="va-middle"><?= $d['email'] ?></td>
                  <td class="va-middle">
                    <span class="badge rounded-pill bg-success"><?= $d['status'] ?></span>
                  </td>
                  <td class="va-middle"><?= $d['created_at'] ?></td>
                  <td class="va-middle">
                    <button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-danger">deactivate</button>
                  </td>
                </tr>
                <?php endforeach; ?>
              </tbody>
        ...
        <form class="form-horizontal form-bordered" action="/csr_adm/conf_admin/register" method="post">
          <?= csrf_field(); ?>
          <section class="panel">
            <header class="panel-heading">
              <div class="panel-actions">
              ...
              <h2 class="panel-title">Register Admin</h2>
            </header>
            <div class="panel-body">
