...
<body>
      ...
      <section role="main" class="content-body">
        ...
        <section class="panel">
          <header class="panel-heading">
            ...
            <h2 class="panel-title">In Review Respondent</h2>
          </header>
          <div class="panel-body">
            <table class="table table-bordered table-striped mb-none" id="datatable-respondent">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="actions">
                    <?php
                  $getaspect = strtolower($r['aspect']);
                  $aspect = str_replace(' ', '', $getaspect);
                  ?>
                    <div
                      style="overflow: hidden; position: absolute; clip: rect(0 0 0 0); width: 1px; height: 1px; margin: -1px;">
                      <input type="text" value="<?=base_url('result_mail/view/detail/'.$aspect.'/'.$r['slug'])?>"
                        id="result<?=$r['id_respondent']?>">
                    </div>

                    <button class="mb-xs mt-xs mr-xs btn btn-xs btn-primary"
                      onclick="copyresult(<?=$r['id_respondent']?>)"><i class="fa fa-clipboard"></i> Copy
                      Result</button>

                    <a href="<?=base_url('csr_adm/adm_respondent/validate/'.$r['id_respondent'])?>"
                      style="color: white;" class="mb-xs mt-xs mr-xs btn btn-xs btn-success"><i
  ...
  <script src="<?=base_url('resources/csrhealth_adm/javascripts/tables/examples.datatables.respondent.js')?>">
  </script>
