      ...
      <section role="main" class="content-body">
        ...
        <section class="panel">
          <header class="panel-heading">
            ...
            <h2 class="panel-title">In Draft Respondent </h2>
          </header>
            ...
            <table class="table table-bordered table-striped mb-none" id="datatable-respondent">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="actions">
                    <a href="<?=base_url('csr_adm/adm_respondent/drop/'.$r['id_respondent'])?>" style="color: white;"
                      class="mb-xs mt-xs mr-xs btn btn-xs btn-danger"
                      onclick="return confirm('Are you sure you want to delete this respondent?');"><i
