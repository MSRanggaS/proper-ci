...
<head>
  ...
  <link rel="stylesheet"
    href="<?=base_url('resources/csrhealth_adm/vendor/bootstrap-fileupload/bootstrap-fileupload.min.css')?>" />
...
<body>
      ...
      <section role="main" class="content-body">
        ...
        <section class="panel">
          ...
          <header class="panel-heading">
            ...
            <h2 class="panel-title">Aspect Proper</h2>
          </header>
          <div class="panel-body">
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
              ...
              <tbody>
                <?php foreach ($aspectproper as $aspect): ?>
                <tr>
                  <td class="va-middle"><?=$aspect['name']?></td>
                  <td class="va-middle">
                    <a class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-xs btn-default"
                      href="#image-<?=$aspect['id_aspectproper']?>"><i class="fa fa-picture-o"></i> Show pict</a>
                  </td>
                  <td class="va-middle">
                    <a href="<?=base_url('csr_adm/adm_aspect/'.$aspect['id_aspectproper'])?>" type="button"
                      class="mb-xs mt-xs mr-xs btn btn-xs btn-primary"><i class="fa fa-info-circle"></i> Detail</a>
                    <a class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-xs btn-danger"
                      href="#confirmation-<?=$aspect['id_aspectproper']?>"><i class="fa fa-trash-o"></i> Delete</a>
                  </td>
                </tr>

                <div id="image-<?=$aspect['id_aspectproper']?>"
                  class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
                  <section class="panel">
                    <header class="panel-heading">
                      <h2 class="panel-title">Image <?=$aspect['name']?></h2>
                    </header>
                    <div class="panel-body">
                      <div class="modal-wrapper" style="padding: 0;">
                        <img src="<?=base_url('uploads/image/'.$aspect['image'])?>" alt="" width="100%">
                      </div>
                    </div>
                ...
                <div id="confirmation-<?=$aspect['id_aspectproper']?>"
                    ...
                    <div class="panel-body">
                      <div class="modal-wrapper">
                        ...
                        <div class="modal-text">
                          <h4>Attention!</h4>
                          <p>Are you sure you want to delete this item? This action will delete all aspect and question
                            with sub-aspect connected to this aspect.</p>
                          <p>Type <strong>"Delete <?=$aspect['name']?>"</strong> to permanently delete this aspect</p>

                          <form action="<?=base_url('csr_adm/adm_aspect/delete/'.$aspect['id_aspectproper'])?>"
                            method="POST">
                            <?=csrf_field()?>
                            <input type="hidden" name="valid-true" value="Delete <?=$aspect['name']?>">
        ...
        <form class="form-horizontal form-bordered" action="<?=base_url('csr_adm/adm_aspect/add')?>" method="POST"
          ...
          <section class="panel">
            <header class="panel-heading">
              ...
              <h2 class="panel-title">Add Aspect Proper</h2>
            </header>
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <label class="col-md-3 control-label" for="name">Aspect Name</label>
                <div class="col-md-6">
              ...
              <div class="form-group">
                <label class="col-md-3 control-label" for="detail">Aspect Detail</label>
                <div class="col-md-6">
                  <textarea class="form-control" rows="3" name="detail" data-plugin-textarea-autosize
                    required></textarea>
                </div>
              </div>
  ...
  <script src="<?=base_url('resources/csrhealth_adm/vendor/bootstrap-fileupload/bootstrap-fileupload.min.js')?>">
  </script>
