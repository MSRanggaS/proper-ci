            ...
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="va-middle"><?=$r['attemppoints']?></td>
                  <td class="va-middle"><?=$r['attemp_date']?></td>
                  <?php
                  $getaspect = strtolower($r['aspect']);
                  $aspect = str_replace(' ', '', $getaspect);
                  ?>
                  <td class="va-middle"><a href="<?=base_url('result_mail/view/detail/'.$aspect.'/'.$r['slug'])?>" target='_blank' type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary"><i
                    class="fa fa-info-circle"></i> Show Detail</a></td>
                </tr>
                <?php endforeach;?>
              </tbody>
            </table>
